...
namespace PFerramenta
{
    class Ferramenta
    {
        ...
        public int Salvar()
        {
            ...
            try
            {
                SqlCommand mycommand;   //Para realizar um comando cria-se um SqlCommand
                mycommand = new SqlCommand("INSERT INTO FERRAMENTA VALUES (@nome, @fornecedor, @distribuicao, @dtcadastro," +
                    "@siteoficial, @categoria_idcategoria)", Form1.conexao);
